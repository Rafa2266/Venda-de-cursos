...
<head>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            <div class="col-md-12  btn-group btn-group-lg btn-group-vertical">
              <a href="http://localhost:8080/Venda-de-cursos/Controlador?idformulario=1&tipoformulario=11" class="btn btn-default">CLIENTES</a>
    ...
    <footer>
      <div class=" bgred navbar navbar-fixed-bottom">
        <div class="container">
          <div class="row">
